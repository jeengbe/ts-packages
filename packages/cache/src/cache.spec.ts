...
describe('Cache', () => {
  ...
  describe('mcached', () => {
    ...
    it('records a miss for those items that are not cached', async () => {
      ...
      expect(onRead).toHaveBeenCalledWith('foo-a', false, CacheOperation.Mcached);
      expect(onRead).toHaveBeenCalledWith('foo-c', false, CacheOperation.Mcached);
    });
    ...
    it('records a hit for those items that are cached', async () => {
      ...
      expect(onRead).toHaveBeenCalledWith('foo-b', true, CacheOperation.Mcached);
      expect(onRead).toHaveBeenCalledWith('foo-d', true, CacheOperation.Mcached);
    });
    ...
    it('records a hit if all items are cached', async () => {
      ...
      expect(onRead).toHaveBeenCalledWith('foo-a', true, CacheOperation.Mcached);
      expect(onRead).toHaveBeenCalledWith('foo-b', true, CacheOperation.Mcached);
      expect(onRead).toHaveBeenCalledWith('foo-c', true, CacheOperation.Mcached);
    });
    ...
    it('records a miss if no items are cached', async () => {
      ...
      expect(onRead).toHaveBeenCalledWith('foo-a', false, CacheOperation.Mcached);
      expect(onRead).toHaveBeenCalledWith('foo-b', false, CacheOperation.Mcached);
      expect(onRead).toHaveBeenCalledWith('foo-c', false, CacheOperation.Mcached);
      expect(onRead).toHaveBeenCalledWith('foo-d', false, CacheOperation.Mcached);
    });
